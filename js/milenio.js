function ShowTooltip(color,left, top, text, cant){
  document.getElementById("tooltip-1").style.display="block";
  document.getElementById("tooltip-1").style.color=color;
  document.getElementById("tooltip-1").style.top=top;
  document.getElementById("tooltip-1").style.left=left;
  document.getElementById("tooltip-p").innerHTML=text;
  document.getElementById("tooltip-cant").innerHTML=cant;
...
function ShowTooltip2(color,left, top, text, cant){
  // document.getElementById("tooltip-2").style.display="block";
  document.getElementById("tooltip-2").style.color=color;
  document.getElementById("tooltip-2").style.top=top;
  document.getElementById("tooltip-2").style.left=left;
  document.getElementById("tooltip-p2").innerHTML=text;
  document.getElementById("tooltip-cant2").innerHTML=cant;
